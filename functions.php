...
function popper_scripts() {
	wp_enqueue_style( 'popper-style', get_stylesheet_uri(), array(), '1.0.0e');
  wp_enqueue_script( 'popper-functions', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '1.0.0e', true );
